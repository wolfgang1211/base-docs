...
graph LR
    subgraph "Ethereum L1"
        OptimismPortal(<a href="../../../network-information/bridges/withdrawals.html#the-optimism-portal-contract">OptimismPortal</a>)
    ...
    subgraph "L2 Node"
        RollupNode(<a href="../../../infrastructure/consensus/">Consensus</a>)
        ExecutionEngine(<a href="./execution/">Execution Engine</a>)
    end

    Batcher(<a href="../../../infrastructure/batcher.html">Batcher</a>)
    Proposers(Proposers)
...
[Bridging →](../../../network-information/bridges/deposits)
...
[Batcher →](../../../infrastructure/batcher)
...
graph LR
    ...
    Batcher(<a href="../../../infrastructure/batcher.html">Batcher</a>)
    BatchInbox(<a href="../reference/glossary.html#batcher-transaction">Batch Inbox Address</a>)
    RollupNode(<a href="../../../infrastructure/consensus/">Rollup Node</a>)
...
graph LR
    ...
    Challengers(Challengers)
    OP(<a href="../../../network-information/bridges/withdrawals.html#the-optimism-portal-contract">OptimismPortal</a>)
