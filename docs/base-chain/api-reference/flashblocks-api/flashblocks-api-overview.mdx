...
<Card>
<ParamField path="parent_beacon_block_root" type="string">EIP-4788 parent beacon block root (Ecotone).</ParamField>
...
```json
{
  ...
  "index": 0,
  "base": {
    "parent_beacon_block_root": "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef",
    ...
    "prev_randao": "0xb4afc0b7ce10e150801bbaf08ac33fecb0f38311793abccb022120d321c6d276",
...
```json
{
  ...
  "diff": {
    ...
    "receipts_root": "0x8d9f3a2e1b5c4d6f7e8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0",
    "logs_bloom": "",
